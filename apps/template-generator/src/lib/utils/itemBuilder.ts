...
import { BDA, DA, DAType, DO, DODetails, DOType, EnumType, SDO } from '../domain';
...
export const buildDOItems = (list: DODetails[], markedSet: Set<string>, overrides?: ConfigOverrideOrFn<DODetails>) =>
