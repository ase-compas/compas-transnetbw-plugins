...
import { DefaultMetadataService } from "./features/type-details/services/default-metadata-service";
import { DefaultManagerService } from "./features/type-details/services/default-manager-service";
...
export const defaultMetadataService = new DefaultMetadataService();
export const defaultMService = new DefaultManagerService(defaultMetadataService, defaultTypeService);