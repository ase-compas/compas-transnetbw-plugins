<script lang="ts">
  ...
  interface Props {
    ...
    marked?: boolean;
    isDragTarget?: boolean; // Indicates if the card is a valid drop target
    canDrop?: boolean; // Indicates if the card can accept a drop of the dragged card
    isOver?: boolean; // Indicates if the card is currently being hovered over by a dragged card
    canDrag?: boolean; // Indicates if the card can be dragged
