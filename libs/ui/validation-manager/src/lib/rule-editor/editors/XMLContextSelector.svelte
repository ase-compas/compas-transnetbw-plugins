<script lang="ts">
  import OscdSmartSelect from '@oscd-transnet-plugins/oscd-component/src/oscd-smart-select/OscdSmartSelect.svelte';
  import OscdTooltip from '@oscd-transnet-plugins/oscd-component/src/oscd-tooltip/OscdTooltip.svelte';
  import { OscdChevronRightIcon } from '@oscd-transnet-plugins/oscd-icons';
  import { getChildElements, SCL_SCHEMA } from '../utils/scl-schema';
