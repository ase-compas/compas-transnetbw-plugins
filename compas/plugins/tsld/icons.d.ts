...
export declare const substationIcon: TemplateResult<2>;
export declare const lineIcon: TemplateResult<2>;
export declare const processIcon: TemplateResult<2>;
export declare const transformerWindingIcon: TemplateResult<2>;
